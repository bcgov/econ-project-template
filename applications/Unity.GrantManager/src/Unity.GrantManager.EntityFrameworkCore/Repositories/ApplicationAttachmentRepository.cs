...
#pragma warning disable CS8613 // Nullability of reference types in return type doesn't match implicitly implemented member.
    ...
    public class ApplicationAttachmentRepository : EfCoreRepository<GrantTenantDbContext, ApplicationAttachment, Guid>, IApplicationAttachmentRepository
#pragma warning restore CS8613 // Nullability of reference types in return type doesn't match implicitly implemented member.
    {
        public ApplicationAttachmentRepository(IDbContextProvider<GrantTenantDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
