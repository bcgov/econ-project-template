...
You can start by launching a sample from the Microsoft [Container Registry](https://mcr.microsoft.com/) and access it in your web browser at `http://localhost:8000`.
...
```console
curl.exe http://localhost:8000/Environment
```
